...
export default function ServicesSection() {
  return (
	<section
	id="services"
	className="scroll-mt-12 bg-white pt-16 sm:pt-14 md:pt-20 pb-16 sm:pb-16 md:pb-[100px] px-10 sm:px-6 md:px-0"
	>
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 text-left">
        <p
        ...
        <h2
          className={`text-[30px] sm:text-[36px] md:text-[42px] font-light italic text-black mb-10 ${arapey.className}`}
        >
          Makeup Services
        </h2>
        ...
        >
          {services.map((service, index) => (
            <SwiperSlide key={index}>
              <div className="w-full h-[420px] bg-white overflow-hidden shadow-xl flex flex-col transition-all duration-300 transform hover:-translate-y-2 hover:bg-[#E0F4F6] group mb-8">
                {/* Image - 60% */}
                ...
                {/* Text - 40% */}
                <div className="flex-1 p-4 text-center flex flex-col justify-center transition-colors duration-300">
                  <h3
                    className={`text-base sm:text-lg text-black font-normal tracking-[.5px] mb-3 group-hover:text-black transition-colors duration-300 ${oswald.className}`}
                  >
